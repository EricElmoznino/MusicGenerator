...
#                           './generated_music', 'dbn')
musician = MusicGenerator(hp.Configuration(epochs=300, train_log_path='./dbn_jazz', pretrain_epochs=0))
musician.train('./training_songs/Jazz')
music = musician.generate(3200, './training_songs/Jazz/005_A_Nighting.mid',
                          './generated_music', 'dbn_jazz')
