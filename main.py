...
#                           './generated_music', 'pop')
# musician = MusicGenerator(hp.Configuration(epochs=200, train_log_path='./jazz75h2m'))
...
musician = MusicGenerator(hp.Configuration(epochs=200, train_log_path='./classical100h2m'))
...
music = musician.generate(3200, './training_songs/Classical/045-BEETHOVEN_-_Op-031_No-03_Piano_Sonata_No-18_E-flat-Maj_The_Hunt_(pb_Koleso).mid',
                          './generated_music', 'classical100h2m')
