...
musician = MusicGenerator(hp.Configuration(epochs=200, train_log_path='./dbnpop', pretrain_epochs=0))
musician.train('./training_songs/Pop')
music = musician.generate(3200, './training_songs/Pop/I_Kissed_A_Girl_-_Chorus.mid',
                          './generated_music', 'dbnpop')
# musician = MusicGenerator(hp.Configuration(epochs=300, train_log_path='./jazz', pretrain_epochs=0))
